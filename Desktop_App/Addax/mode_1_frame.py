...
class Mode_1_Frame(tk.Frame):
    ...
    def createWidgets(self):
        ...
        '''
        self.user_freq_label = tk.Label(self, text="Period[ms] (B)").grid(column=0,row=0, sticky=tk.W)
        self.user_freq_scaler = tk.Scale(self, from_=0.1, to=5.8, resolution = 0.01, length= 300,orient=tk.HORIZONTAL)
