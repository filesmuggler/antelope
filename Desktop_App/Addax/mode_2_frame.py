...
class Mode_2_Frame(tk.Frame):
    ...
    def createWidgets(self):
        ...
        '''
        self.user_freq_label = tk.Label(self, text="Period[us] (B)").grid(column=0,row=0, sticky=tk.W)
        self.user_freq_scaler = tk.Scale(self, from_=1, to=23, resolution = 0.1, length= 300,orient=tk.HORIZONTAL)
        ...
        self.user_delay_label = tk.Label(self, text="Delay[us] (C)").grid(column=0,row=6, sticky=tk.W)
        self.user_delay_scaler = tk.Scale(self, from_=0, to=23, resolution = 0.1, length= 300,orient=tk.HORIZONTAL)
